...
class Hangman:
    ...
    def __init__(self, word_list, num_lives=5):
        ...
        self.word = word_list[index_word]
    ...
    def check_letter(self, letter) -> None:
        ...
        # letter converted from original into lower case
        letter = str.lower(letter)
        word_lower = str.lower(self.word)
        count_letter = word_lower.count(letter)
        ...
        if count_letter == 1:
            ...
            #UNIQUE letters in the word that have not been guessed then reduce number of unique letters num_letters by 1
            self.num_letters -= 1

            #printing updated word
